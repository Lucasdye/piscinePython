...
def main():
  """
  Summary: This script isolates into a list the words from the string
  that are bigger than N characters long and prints them. The string and N are given
  as argumemts in the command line.
  """
  argc = len(arg.argv)
